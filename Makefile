...
#    Updated: 2019/03/15 21:17:51 by nsondag          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
FILES = main.o parser.o parser2.o parser3.o exit.o smallest.o supp_mult_path.o\
supp_mult_path2.o dead_ends.o path.o print.o print2.o cross.o change_len.o 
